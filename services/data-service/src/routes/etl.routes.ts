...
/**
 * GET /etl-jobs (root - alias for /jobs)
 * Also accessible via /etl/jobs
 */
...
/**
 * POST /etl-jobs/:jobId/kill (root path alias)
 */
router.post('/:jobId/kill', authenticate, authorize(ROLES.ADMIN, ROLES.MANAGER), async (req: Request, res: Response, next: NextFunction) => {
  try {
